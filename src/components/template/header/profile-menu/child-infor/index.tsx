...
const ChildInforPage = (props: any) => {
                ...
                <div>
                  {/* <Container>
                    <FlexboxGrid style={{ height: 100 }} align="middle">
                      <FlexboxGrid.Item colspan={8}>
                        ...
                        profileImageProgress < 99 ? (
                          ...
                          <div className="circle-image">
                            <img src={profileImage} alt="your-image-alt" />
                            <div className="icon">
                              <Icon
                                icon="camera"
                      ...
                      <FlexboxGrid.Item style={{ color: "black" }} colspan={16}>
                        <Row>
                          <h4>
                            {learnerFirstName} {learnerFirstName} <br />
                          </h4>
                        </Row>
                        <Row>
                          <span>{learnerRole}</span>
                        </Row>
                      </FlexboxGrid.Item>
                    </FlexboxGrid>
                  </Container> */}
                      ...
                      <div className="form-field">
                        <InputGroup>
                          ...
                          <Input
                            ...
                            onChange={(value) => {
                              setLearnerInfoUpdate(true);
                              setLearnerFirstName(value);
                            }}
                          />
                        </InputGroup>
                      </div>
  ...
  return (
    <Container>{!showLinkedUser ? ChildInfor() : <p>No Child</p>}</Container>
  );
};
export default ChildInforPage;
