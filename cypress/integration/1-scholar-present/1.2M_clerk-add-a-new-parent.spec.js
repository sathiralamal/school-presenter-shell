...
describe('1.2 Clerk - Add a new Parent', () => {
    ...
    it.only('1.2.1 I want to make sure that the correct parent is linked to the correct Learner', () => {
    ...
    it('1.2.5 I want to be able to link parents to existing groups - (Grade 10 learners group and Grade 10 parent group)', () => {
        ...
        cy.get('[style="display: block; transform: translate(0px, 0px);"] > :nth-child(1) > .learner-tab1 > .LearnerPhoneEmail > :nth-child(1) > .allow-dropdown > .rs-input').type(Number).then
