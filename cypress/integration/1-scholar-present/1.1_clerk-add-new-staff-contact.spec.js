...
describe('1.1 Clerk - Add New Staff contact', () => {
    ...
    it('1.1.1. I want to add new staff individually (Personal Information and Contact information)', () => {
        ...
        cy.get('[style="display: block;"] > ion-grid.md > form > :nth-child(2) > :nth-child(1) > .rs-input').click().type('Phakhathi').then
        cy.get('[style="display: block;"] > ion-grid.md > form > :nth-child(2) > :nth-child(2) > .rs-input').click().type('Desmond').then
    ...
    it('1.1.4 I want to be able to upload all the staff members at once', () => {
    ...
    it.only('1.1.5 I want to be able to update the information and class assignment easily', () => {
        cy.reload()
        cy.get('.rs-input').click().then
        cy.get('.rs-input').type('090200').then
        cy.get('#continueBtn').click().then
        ...
        cy.get('[style="display: block;"] > :nth-child(1) > .learner-tab1 > :nth-child(2) > :nth-child(1) > .rs-input').clear()
        cy.get('[style="display: block;"] > :nth-child(1) > .learner-tab1 > :nth-child(2) > :nth-child(1) > .rs-input').click().type('willard').then
        cy.get('[style="display: block;"] > :nth-child(1) > .learner-tab1 > :nth-child(2) > :nth-child(1) > .rs-input').click({force: true})
        // cy.get('[style="display: block; transform: translate(0px, 0px);"] > :nth-child(1) > .learner-button-container > .learner-submit-button').click()
        // cy.get('[style="display: block; transform: translate(0px, 0px);"] > :nth-child(1) > .learner-button-container > .learner-submit-button').click()
        // cy.get('.alert-button-inner').click()
        cy.get('#editLearnerNumber').type(learnerNumber).then
        cy.get('[style="display: block;"] > :nth-child(1) > .learner-button-container > .learner-submit-button').click().then
