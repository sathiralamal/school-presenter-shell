...
describe('Create New School', () => {
    ...
    it('1.3.2 I want to be able to add a learner individually', () => {
        ...
        cy.get('[style="display: block; transform: translate(0px, 0px);"] > :nth-child(1) > .learner-tab1 > .LearnerPhoneEmail > :nth-child(1) > .allow-dropdown > .rs-input').type(learnerNumber).then
